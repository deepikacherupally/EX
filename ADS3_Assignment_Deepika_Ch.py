# -*- coding: utf-8 -*-
"""
Created on Thu May 11 16:24:42 2023
...
def plot_clustered_data(df, cluster_labels, cluster_centers):
    ...
    ax.scatter(cluster_centers[:, 0], cluster_centers[:, 1], s=200, marker='X', c='black')
...
def filter_population_data(filename, countries, indicators, start_year, end_year):
    ...
    population_data['Value'] = pd.to_numeric(population_data['Value'], errors='coerce')
...
predict_future(r"C:\Users\ACER\Downloads\climate_change_wbdata (1).csv", ['India', 'China', 'United States'], ['Population, total'], 1990, 2020)
map_corr(df, size=8)
